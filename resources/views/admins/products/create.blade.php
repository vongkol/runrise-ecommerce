...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{url('/admin/product/save')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" id="price" name="price" class="form-control" step="0.1" min="0">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" id="discount" name="discount" class="form-control" step="0.1" min="0">
                    </div>
                </div>
                <div class="form-group row">
