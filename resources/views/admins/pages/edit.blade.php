...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{url('/admin/page/update/' . $page->id . '/' . $pgnum)}}" class="form-horizontal" method="POST">
                {{csrf_field()}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        <textarea name="description" id="description" cols="30" rows="10">{!! $page->description !!}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12">
